...
const AddManager = ({ openModal }) => {
  return (
    <li key="addmanager" className="flex flex-row justify-end items-center gap-6 pb-3 px-5">
      ...
      <img className="h-[40px] border-[2px] border-neutral-400 rounded-full" src={`/templateUser.svg`} />
    </li>
  );
};
